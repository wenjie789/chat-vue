    ...
    <div class="reply-item">
        <div class="header-wrap">
            ...
            <div class="timestamp">
                ...
                " negative-text="取消" positive-text="確認" @positive-click="execDelAction">
                    <template #trigger>
        ...
        <div class="base-wrap">
            ...
            <div class="reply-switch">
                ...
                <div class="actions">
                    ...
                    <span v-if="store.state.userLogined" class="show opacity-item reply-btn" @click="focusReply"> 回復 </span>
                </div>
            </div>
        </div>
    </div>
