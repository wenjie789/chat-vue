<template>
    <div class="rightbar-wrap" v-if="!store.state.collapsedRight">
        ...
        <n-card v-if="showFollowTopics" class="hottopic-wrap" title="關注話題" embedded :bordered="false" size="small">
            <n-spin :show="loading">
        ...
        <n-card class="hottopic-wrap" title="熱門話題" embedded :bordered="false" size="small">
            <n-spin :show="loading">
