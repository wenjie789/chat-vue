        ...
        <div class="auth-wrap">
            <n-card :bordered="false">
                <div v-if="!allowUserRegister">
                    <n-space justify="center"><n-h3><n-text type="success">帳號登錄</n-text></n-h3></n-space>
                    <n-form
                            ref="loginRef"
                            :model="loginForm"
                            :rules="{
                        ...
                        >
                            <n-form-item-row label="帳戶" path="username">
                                <n-input
                ...
                >
                    ...
                    <n-tab-pane name="signup" tab="註冊">
                        <n-form
                            ...
                            :rules="registerRule"
                        >
                            <n-form-item-row label="用戶名" path="username">
                                <n-input
                                    v-model:value="registerForm.username"
                                    placeholder="用戶名註冊後無法修改"
                                />
                            </n-form-item-row>
                            <n-form-item-row label="密碼" path="password">
                                <n-input
                            ...
                            <n-form-item-row label="重複密碼" path="repassword">
                                <n-input
                                    type="password"
                                    show-password-on="mousedown"
                                    placeholder="請再次輸入密碼"
